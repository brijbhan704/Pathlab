...
$entryid=mt_rand(100000000, 999999999);
 ...
 $query=mysqli_query($con,"insert into tblusers(EntryID,UserName,UserAddress,MobileNumber,Email,Password,IDProof,role_id) value('$entryid','$username','$uadd','$mobilenumber','$email','$Password','$idproof','$roles')");
...
<head>
    ...
    <title>Pathlab User Details</title>
                ...
                <div class="row form-group">
                    <div class="col-12">
                        ...
                        <div class="form-group"><label for="city" class=" form-control-label">Email</label><input type="email" name="email" id="email" value="" class="form-control" required="true"></div>
                         ...
                         <div class="col-12">
                        <div class="form-group"><label for="city" class=" form-control-label">Password</label><input type="password" name="Password" id="email" value="" class="form-control" required="true" autocomplete="new-password"></div>
                        </div>
                        ...
                        <div class="col-12">
                        <div class="form-group"><label for="city" class=" form-control-label">Select Roles</label><select type="text" name="roles" id="cname" value="" class="form-control" required="true">
                        <option value="">Choose Roles</option>
            <?php $query=mysqli_query($con,"select * from  roles");
