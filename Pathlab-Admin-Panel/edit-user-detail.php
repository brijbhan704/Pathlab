...
$IDProof=$_POST['IDProof'];
 ...
 $query=mysqli_query($con,"update  tblusers INNER JOIN roles ON tblusers.role_id=roles.id SET UserName='$UserName',UserAddress='$UserAddress',MobileNumber='$MobileNumber',Email='$Email',name='$roles',IDProof='$IDProof',name='$roles' where  tblusers.ID='$eid'");
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="manage-newusers.php">Update Users Detail</a></li>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><strong>User</strong><small> Detail</small></div>
...
//$ret=mysqli_query($con,"select * from  tblusers where ID='$cid'");
 $ret=mysqli_query($con,"select * from tblusers INNER JOIN roles ON tblusers.role_id=roles.id where tblusers.ID='$cid'");
$cnt=1;
while ($row=mysqli_fetch_assoc($ret)) {

?>                              
    <div class="form-group"><label for="company" class=" form-control-label">User Name</label><input type="text" name="UserName" value="<?php  echo $row['UserName'];?>" class="form-control" id="compname" required="true"></div>
