        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <h3 style="color: white">Pathlab Management System </h3>
                    <hr  color="red"/>
                </div>
    ...
    echo $msg;
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" placeholder="Password" name="password" required="true" autocomplete="new-password">
                        </div>
                                <div class="checkbox">
