...
<head>
    ...
    <title>Pathlab Manage Test</title>
...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <p style="text-align: right;"><a href="add-category.php"><button type="submit" class="btn btn-primary btn-xs" name="submit" id="submit">
                                <i class="fa fa-list-alt"></i>  Add Test
                                </button></a></p>
 ...
 <?php
            ...
            // selecting rows
            $sql = "SELECT * FROM sub_category where parent_id='0' ORDER BY ID ASC limit $row,".$rowperpage;
            $result = mysqli_query($con,$sql);
            $sno = $row + 1;
            while($fetch = mysqli_fetch_array($result)){
               ...
               // $salary = $fetch['Email'];
                ...
                <tr>
                    ...
                    <a href="view-subcategory.php?id=<?php echo $fetch['id'];?>"><button class="btn btn-success btn-xs">View SubTest</i></button></a>
