...
<head>
    ...
    <title>Pathlab Manage Users</title>
...
<body>
 ...
 <?php
            ...
            $sql = "SELECT COUNT(*) AS cntrows FROM tblusers";
            $result = mysqli_query($con,$sql);
            $fetchresult = mysqli_fetch_array($result);
            $allcount = $fetchresult['cntrows'];

            // selecting rows
            $sql = "SELECT * FROM tblusers  ORDER BY ID ASC limit $row,".$rowperpage;
            $result = mysqli_query($con,$sql);
            $sno = $row + 1;
            while($fetch = mysqli_fetch_array($result)){
                ...
                <tr>
                    ...
                    <td >
                    <a href="view-user-detail.php?upid=<?php echo $fetch['ID'];?>"><button class="btn btn-success btn-xs"><i class="fa fa-eye"></i></button></a>

                    <a href="edit-user-detail.php?upid=<?php echo $fetch['ID'];?>"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>

                    <a href="delete-user.php?id=<?php echo $fetch['ID'];?>"> 
